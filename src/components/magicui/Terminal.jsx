...
export function Terminal({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 h-full max-h-[280px] w-full max-w-lg overflow-hidden rounded-xl border border-white/[0.08] bg-[#0d1117] shadow-xl",
        className
      )}
    >
      <div className="flex flex-col gap-y-2 border-b border-white/[0.06] p-4">
      ...
      <pre className="p-4 font-mono text-sm">
        <code className="grid gap-y-1 overflow-auto text-slate-300">
          {wrappedChildren}
        </code>
      </pre>
    </div>
